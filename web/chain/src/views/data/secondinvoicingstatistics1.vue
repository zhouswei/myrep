...
<template>
  <div>
    <div class="shopSumaryInfo">
      ...
      <div class="shopBaseSon" style="background-color:#fab152;"><p>开卡/充值/充次总金额</p><p>{{totalPrice}}</p></div>
      <div class="shopBaseSon" style="background-color:#8fc31f;"><p>开卡/充值/充次实收总金额</p><p>{{realPrice}}</p></div>
      <div class="shopBaseSon" style="background-color:#fa6c5f;"><p>赠送总金额</p><p>{{fresPrice}}</p></div>
    </div>
    ...
    <p style="color:red;font-size:15px;">提示：开卡/充值/充次总金额 = 开卡/充值/充次实收总金额 + 赠送总金额;</p>
    </div>
    <el-pagination
