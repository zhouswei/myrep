    ...
    <div class="right-menu">
      ...
      <el-dropdown class="avatar-container right-menu-item" trigger="click" @command="handleCommand">
        <div class="avatar-wrapper">
          <p class="user-name-text"><img :src="tranlatePath('static/img/user_account.png')">{{name}}</p>
      ...
      <div class="right-shop-name" @click="shopclick">
        <img class="right-shop-img" :src="tranlatePath('static/img/shopManNav.png')">
...
export default {
  ...
  methods: {
    ...
    shopclick () {
      // browser 打开 mobile 关闭
      this.$store.dispatch('checkDialogIndex', {info: 3}).then(() => {
        this.$store.dispatch('setDialogShow', {info: true}).then(() => {
