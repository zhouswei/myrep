<template>
  <div v-loading="loading">
    ...
    <p class="infoPerLine1" style="position: relative">
      ...
      <el-input v-model="pro6" class="shop_size" type="text" autoComplete="off"/>
    ...
    <p class="infoPerLine" style="position:relative;">
      ...
      <el-input class="address_detail" type="text" v-model="address" autoComplete="off" placeholder="地址" />
