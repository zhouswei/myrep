...
<template>
  <div>
    <el-main v-loading="listLoading" element-loading-background="rgba(0, 0, 0, 0.5)"
  ...
  methods: {
    getData () {
      ...
      this.$store.dispatch('GetMemberCastListDetail', this.sendData).then((response) => {
        ...
        obj.tableData1Pro4 = '￥' + (response.OrderInfoList.SalePrice - response.OrderInfoList.PayPrice)
        obj.tableData1Pro5 = '￥' + response.OrderInfoList.PayPrice
        ...
        obj.tableData1Pro7 = obj.tableData1Pro7 === '()' ? '' : obj.tableData1Pro7
        ...
        response.ServiceListInfo.forEach(element => {
          ...
          obj.tableData3Pro11 = '￥' + element.RealPrice
