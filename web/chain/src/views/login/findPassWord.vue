  ...
  <div>
    <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
      ...
      <el-form-item class="el-self-item_class" label="新密码：" prop="newPassword">
        <input v-model="ruleForm.newPassword" placeholder="请设置您的新密码" type="password" class="spec-input"/>
        <span style="color: #e33c32">*</span>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getAuthCode: function () {
      ...
      this.$store.dispatch('queryVeriCode', {code: this.ruleForm.name, mobile: this.ruleForm.mobile, type: '1'}).then((response) => {
