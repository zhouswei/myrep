  ...
  <div class="login-container">
    <el-form class="login-form" :style="styleObj" autoComplete="on" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left">
      ...
      <el-form-item prop="shopserialnum">
        ...
        <el-input name="shopserialnum" type="text" v-model="loginForm.shopserialnum" autoComplete="on" placeholder="请输入连锁机构代码" />
      </el-form-item>
      ...
      <el-form-item prop="password">
        ...
        <el-input name="password" :type="passwordType" @keyup.enter.native="handleLogin" ref="input1" v-model="loginForm.password" autoComplete="new-password" placeholder="请输入登录密码" />
    ...
    <p class="f_p"><a class="fp_a" target="_blank" href="http://www.beian.miit.gov.cn">粤ICP备14101347号</a></p>
    <el-dialog
...
export default {
  ...
  data () {
    ...
    const validateShopnum = (rule, value, callback) => {
      if (value.length < 4) {
        callback(new Error('连锁机构吗不能少于4位'))
      } else {
        callback()
      }
    }
