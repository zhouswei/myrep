    ...
    <div v-loading="loading">
      ...
      <p class="infoPerLine1">
        <span class="infoShowName">可发卡门店：</span>
          <el-transfer :titles="['全选', '全选']"  class="transfer_wrap" v-model="checkSendShop" :data="shopsSendData"></el-transfer>
      </p>
      <p class="infoPerLine1">
        <span class="infoSh owName">可用卡门店：</span>
          <el-transfer :titles="['全选', '全选']"  class="transfer_wrap" v-model="checkUseShop" :data="shopsUseData"></el-transfer>
      </p>
