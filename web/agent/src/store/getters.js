...
const getters = {
  ...
  projName: state => state.user.projName,
  peoplePositionList: state => state.user.peoplePositionList,
  carInfoList: state => state.user.carInfoList,
  doorGuardList: state => state.user.doorGuardList,
  vedioList: state => state.user.vedioList,
  userno: state => state.user.userno,
  SessionKey: state => state.user.SessionKey,
  htmlContent: state => state.user.htmlContent,
  versionList: state => state.user.versionList,
  chainList: state => state.user.chainList,
