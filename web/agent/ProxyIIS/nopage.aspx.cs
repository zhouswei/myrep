...
public partial class nopage : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        roules.Add("/api/", "http://api.handnear.com");
        roules.Add("/up/", "http://up.handnear.com");

        string Post = "";
        foreach (var key in Request.Form.Keys) {
            Post += Post == "" ? "" : "&";
            Post += key + "=" + Request.Form.Get(key.ToString());
        }
        ...
        //System.IO.File.WriteAllText(AppDomain.CurrentDomain.BaseDirectory + "log.txt", Request.Url.ToString() + "  RealUrl:" + realUrl + "  POST:" + Post);
        var result = CreateHttpRequest(realUrl, Request);
        //System.IO.File.WriteAllText(AppDomain.CurrentDomain.BaseDirectory + "log2.txt", result);
